...
var _dataJs = require("./src/data.js");
...
(0, _dataJs.dishes).forEach((prato)=>pratosContainer.appendChild(getPratoView(prato)));
const bebidasContainer = document.querySelector(".opcoes.bebida");
(0, _dataJs.drinks).forEach((bebida)=>bebidasContainer.appendChild(getBebidaView(bebida)));
const sobremesasContainer = document.querySelector(".opcoes.sobremesa");
(0, _dataJs.desserts).forEach((sobremesa)=>sobremesasContainer.appendChild(getSobremesaView(sobremesa)));
...
},{"./src/data.js":"jt5O3"}],"jt5O3":[function(require,module,exports) {
